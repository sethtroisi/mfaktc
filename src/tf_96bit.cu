...
__device__ static void test_FC96_mfaktc_95(int96 f, int192 b, unsigned int exp, unsigned int *RES, unsigned int *PROOF, int shiftcount
#ifdef DEBUG_GPU_MATH
...
this kernel has a lower FC limit of 2^64 so we can use check_big_factor96() */
  check_factor96(f, a, RES, PROOF);
}


__global__ void
#ifdef SHORTCUT_75BIT
__launch_bounds__(THREADS_PER_BLOCK,2) mfaktc_75(unsigned int exp, int96 k, unsigned int *k_tab, int shiftcount, int192 b, unsigned int *RES, unsigned int *PROOF
#else
__launch_bounds__(THREADS_PER_BLOCK,2) mfaktc_95(unsigned int exp, int96 k, unsigned int *k_tab, int shiftcount, int192 b, unsigned int *RES, unsigned int *PROOF
#endif
#ifdef DEBUG_GPU_MATH
                                                 , unsigned int *modbasecase_debug
#endif
...
a is precomputed on host ONCE. */
{
  ...
  test_FC96_mfaktc_95(f, b, exp, RES, PROOF, shiftcount
#ifdef DEBUG_GPU_MATH
                      , modbasecase_debug
#endif
                      );
...
__global__ void
#ifdef SHORTCUT_75BIT
__launch_bounds__(THREADS_PER_BLOCK,2) mfaktc_75_gs(unsigned int exp, int96 k_base, unsigned int *bit_array, unsigned int bits_to_process, int shiftcount, int192 b, unsigned int *RES, unsigned int *PROOF
#else
__launch_bounds__(THREADS_PER_BLOCK,2) mfaktc_95_gs(unsigned int exp, int96 k_base, unsigned int *bit_array, unsigned int bits_to_process, int shiftcount, int192 b, unsigned int *RES, unsigned int *PROOF
#endif
#ifdef DEBUG_GPU_MATH
                                                 , unsigned int *modbasecase_debug
#endif
